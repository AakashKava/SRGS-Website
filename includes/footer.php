<!-- Footer -->
    <footer>
      ...
      <div
        ...
        style="background-image: url(<?= BASE_URL ?>assets/img/footer/footer-bg-large-main.jpg)"
      >
          ...
          <div class="container">
            <div class="row footer-custom-row">
              <div class="col-12 col-md-6">
                ...
                >
                  <a class="footer-logo" href="/" aria-label="Logo">
                    <img
                      src="<?= BASE_URL ?>assets/img/srgs-logo.png"
                      alt="Logo"
    ...
    <!-- all js -->
    <script src="<?= BASE_URL ?>assets/js/vendor.js" defer></script>
