...
<html lang="en" class="no-js">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="<?= BASE_URL ?>assets/img/srgs-favicon.png"
      type="image/x-icon"
    />
  ...
  <body>
        ...
        <div class="container-fluid">
          <div class="header-grid">
            <a class="header-logo" href="/" aria-label="Logo">
              <img
                src="<?= BASE_URL ?>assets/img/srgs_logo_no_bg.png"
                alt="Logo"
                style="width:45%;"
              />
            </a>
            <drawer-menu>
              <nav class="header-nav drawer-menu">
                ...
                <ul class="header-menu list-unstyled">
                  <li class="nav-item">
                    <a class="menu-link menu-link-main menu-accrodion" href="<?= BASE_URL ?>">
                      Home
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="menu-link menu-link-main" href="<?= BASE_URL ?>about">
                      About Us
                    </a>
                  </li>
                  ...
                  <li class="nav-item">
                    <a class="menu-link menu-link-main" href="<?= BASE_URL ?>contact">
                      Contact
                    </a>
                  </li>
                </ul>
    ...
    <div class="theme-drawer drawer-additional" data-position="right">
      <div class="drawer-headings">
        <a class="header-logo" href="/" aria-label="Logo">
          <img
            src="<?= BASE_URL ?>assets/img/srgs_logo_no_bg_drawer.png"
            alt="Logo"
            style="width: 45%;"
            loading="lazy"
          />
