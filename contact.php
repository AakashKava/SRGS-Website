    ...
    <div class="section-contact-form section-padding">
        ...
        <div class="contact-box radius18">
            ...
            <div class="col-12 col-lg-6 col-contact-content">
                ...
                <h3 class="heading text-30" data-aos="fade-up">
                    Leading Geotechnical Investigation &
                </h3>
                <h3 class="heading text-30" data-aos="fade-up">
                    Survey Company in India
                </h3>
                <p class="text text-18" data-aos="fade-up">
                   Shri Ram Geo Solution is an ISO 9001:2015 certified geotechnical consultancy providing reliable soil investigation, topographical surveys, and foundation engineering services. With years of expertise and advanced testing methods, we help ensure safe, cost-effective, and high-quality project execution across India and international locations.
                </p>
                ...
                <div class="card-icon-text card-icon-text-horizontal">
                    ...
                    <p class="text text-16" data-aos="fade-up">
                        Successfully completed geotechnical investigations for railways, pipelines, irrigation systems, and infrastructure projects across multiple regions.
                    </p>
                    </div>
                </div>
                <div class="card-icon-text card-icon-text-horizontal">
                    ...
                    <p class="text text-16" data-aos="fade-up">
                        Trusted by leading organizations for accurate testing, reliable reporting, and professional engineering consultancy services.
                    </p>
                    </div>
                </div>
                </div>
            ...
            <div class="col-12 col-lg-6 col-contact-form">
                ...
                <div class="contact-form-headings">
                    ...
                    Request a Geotechnical Consultation
                    </h2>
                    <p class="text text-16" data-aos="fade-up">
                    Get expert advice and accurate investigation solutions for your project. Our team will respond quickly with the best approach tailored to your needs.
                    </p>
                </div>
                <form action="contact-submit.php" method="post" class="form contact-form" data-aos="fade-up">
                    <div class="field">
